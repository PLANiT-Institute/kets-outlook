...
전달승수 T의 세 극한이 브리프가 인용한 실증과 정확히 대응한다:
    ...
    λ=0, ψ=0         → T=0        무반응  (Yu & Lee 2020: 잠깐 dip 후 추세 복귀)
    λ=0, ψ<0         → T<0        역효과  (Yu & Lee 2023: 긴축이 매물출하 유발→가격↓)
...
참고 (2026-08-09 KCI 서지 대조 완료 — 저자 로마자·학술지명 정정):
  - Yu, Jongmin & Lee, Jiwoong (2020). The Effectiveness of Allowance Banking
    Restriction Rules in the Korean Emissions Trading Scheme.
    한국기후변화학회지 (J. Climate Change Res.) 11(3), 177–186.
    → 2019-06 이월제한 발표 직후 KAU18 일시 하락, 이후 기존 추세로 복귀. ψ ≈ 0.
  - Yu, Jongmin & Lee, Seojin (2023). 배출권거래제 2차 계획기간 중 이월한도 정책에
    대한 비선형최적화 분석. 자원환경경제연구 32(3), 149–166.
    DOI 10.15266/KEREA.2023.32.3.149
    → 동태 비선형 최적화. 규제기간 중 매물출하 효과로 가격 하락. ψ < 0.
