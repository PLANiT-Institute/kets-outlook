# GENERATED — DO NOT EDIT. 원본: kets/engine.py (scripts/sync_engine.py가 재생성)
"""K-ETS 가격전망 엔진 v0.8.
...
from api._engine.hotelling import hotelling_price_path
from api._engine.liquidity import realized_price_path, lambda_ramp, liquidity_lambda
...
class KETSModel:
    ...
    def from_excel(cls, macc_mode: str = "step"):
        ...
        from api._engine.excel_source import load_data_from_excel
    ...
    def solve_package(self, pkg: dict) -> list[dict]:
        ...
        """
        from api._engine.policy_grid import floor_at, max_defensible_price
